  ...
  <ul class="space-y-2">
    <li>
      ...
      >
        ...
        <Link href="/admin/dashbord"><span class="ml-3">Dashboard</span></Link>
      </a>
    </li>
    <li>
      <button
      ...
      <ul id="dropdown-pages" class="hidden py-2 space-y-2">
        <li>
          <Link
            :href="route('admin.dashbord.cars.index')"
        ...
        <li>
          <Link
            :href="route('admin.dashbord.trainer.index')"
            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            >Moniteurs</Link
          >
        </li>
        <li>
          <Link
            :href="route('admin.dashbord.candidats.index')"
            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            >Candidats</Link
          >
        </li>
